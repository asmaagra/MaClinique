		...
		<?php endif; ?>
			...
			<div class="form-group">
				...
				<select class="browser-default custom-select" name="status">
					<option value="0" <?php echo isset($status) && $status == 0 ? "selected" : '' ; ?>>Demande</option>
					<option value="1" <?php echo isset($status) && $status == 1 ? "selected" : '' ; ?>>Confirmer</option>
					<option value="2" <?php echo isset($status) && $status == 2 ? "selected" : '' ; ?>>Reporté</option>
					<option value="3" <?php echo isset($status) && $status == 3 ? "selected" : '' ; ?>>Terminé</option>
				</select>
			</div>
			...
			<div class="col-md-12 text-center">
				<button class="btn-primary btn btn-sm col-md-4">Mettre à jour</button>
				<button class="btn btn-secondary btn-sm col-md-4  " type="button" data-dismiss="modal" id="">Fermer
