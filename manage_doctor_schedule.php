...
<div class="container-fluid">
	...
	<hr>
		<div class="row">
			<button class="btn btn-primary btn-sm col-md-3 mr-2" >Enregistrer</button>
			<button class="btn btn-secondary btn-sm col-md-3  " type="button" data-dismiss="modal" id="">Fermer</button>
		</div>
	</div>
	</form>
</div>
