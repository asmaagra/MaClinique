...
<div class="container-fluid">
	...
	<hr>
		<div class="row">
			<button class="btn btn-primary btn-sm col-md-3 mr-2" type="button" id="edit">Editer</button>
			<button class="btn btn-secondary btn-sm col-md-3  " type="button" data-dismiss="modal" id="">Terminer</button>
		</div>
	</div>
</div>
<script>
