...
<div class="container-fluid">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				<button class="btn-primary btn btn-sm" type="button" id="new_appointment"><i class="fa fa-plus"></i> Ajouter rendez-vous</button>
				<br>
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							...
							<?php endif ?>
							<?php if($row['status'] == 2): ?>
								<span class="badge badge-info">Reporté</span>
							<?php endif ?>
							<?php if($row['status'] == 3): ?>
						...
						<td class="text-center">
							<button  class="btn btn-primary btn-sm update_app" type="button" data-id="<?php echo $row['id'] ?>">Mettre à jour</button>
							<button  class="btn btn-danger btn-sm delete_app" type="button" data-id="<?php echo $row['id'] ?>">Supprimer</button>
						</td>
					</tr>
				<?php endwhile; ?>
				</table>
